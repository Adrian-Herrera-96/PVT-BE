...
class EconomicComplement extends Model
{
    ...
    public static function basic_info_complements()
    {
        ...
        eco_com_updated_pensions.aps_total_fsa as fraccion_saldo_acumulada_APS_AM,
        eco_com_updated_pensions.aps_total_cc as fraccion_compensacion_cotizaciones_APS_AM,
        eco_com_updated_pensions.aps_total_fs as fraccion_solidaria_vejez_APS_AM,
        eco_com_updated_pensions.aps_disability as pension_de_invalidez_AM,
        eco_com_updated_pensions.aps_total_death as pension_por_muerte_AM,
        eco_com_updated_pensions.total_rent as total_renta_AM";
